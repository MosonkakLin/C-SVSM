function mpc = case39_g2_g8_to_renewable
...
mpc.bus = [
	...
	12	1	0	88	0	0	1	1.000815	-8.9988236	345	1	1.06	0.94;
	13	1	8.53	0	0	0	1	1.014923	-8.9299272	345	1	1.06	0.94;
	...
	20	1	230	103	0	0	3	0.99101054	-6.8211783	345	1	1.06	0.94;
	...
	31	3	150	4.6	0	0	1	0.982	0	345	1	1.06	0.94;
...
mpc.gen = [
	30	250	161.762	400	140	1.0499	100	1	1040	0	0	0	0	0	0	0	31.2 312 936 0 0;
	31	677.871	221.574	300	-100	0.982	100	1	80	0	0	0	0	0	0	0	0.8 8 24 0 0;
	32	650	206.965	300	150	0.9841	100	1	725	0	0	0	0	0	0	0	21.75	217.5	652.5	0	0;
	33	632	108.293	250	0	0.9972	100	1	978	0	0	0	0	0	0	0	9.78	97.8	293.4	0	0;
	34	508	166.688	167	0	1.0123	100	1	762	0	0	0	0	0	0	0	15.24	152.4	457.2	0	0;
	35	650	210.661	300	-100	1.0494	100	1	1030.5	0	0	0	0	0	0	0	20.61	206.1	618.3	0	0;
	36	560	100.165	240	0	1.0636	100	1	580	0	0	0	0	0	0	0	23.2	232	696	0	0;
	37	540	-1.36945	250	0	1.0275	100	1	846	0	0	0	0	0	0	0	8.46	84.6	253.8	0	0;
	38	830	21.7327	300	-150	1.0265	100	1	865	0	0	0	0	0	0	0	34.6	346	1038	0	0;
	39	1000	78.4674	300	-100	1.03	100	1	1650	0	0	0	0	0	0	0	33	330	990	0	0;
];
...
%%-----  OPF Data  -----%%
%% generator cost data
%	1	startup	shutdown	n	x1	y1	...	xn($/MWh)	yn   remark  (k$/100MW2h) (k$/100MWh)
...
24	0.28
25	1.98880000020427
26	0.492992103750718
27	0.492992112705293
28	0.45
29	0.45
30	2.3
31	2.3
...
%% generator carbon emission factor data
%   generator order follows mpc.gen rows
mpc.carbon_profile = 'g2_g8_to_renewable';
mpc.carbon_wg = [
    1e-6;
    1e-6;
    1e-6;
